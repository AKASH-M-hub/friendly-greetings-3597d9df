...
-- Project: nwpjymhpfdsmiakfjoxf
-- =============================================

-- Step 1: Create New Tables
-- =============================================

-- 1.1 MCQ Question Bank
...
-- 1.5 Recovery Activity Type Enum
DO $$ BEGIN
...
-- 1.7 Institutional Support Fund
...
-- Knowledge Progression Policies
...
-- Institutional Support Fund Policies
...
-- Function: Get Eligible MCQ Questions
CREATE OR REPLACE FUNCTION public.get_eligible_mcq_questions(
  p_user_id UUID,
...
INSERT INTO public.mcq_questions (topic, skill_level, question_text, option_a, option_b, option_c, option_d, correct_option, explanation) VALUES
('JavaScript', 'beginner', 'What is the output of: console.log(typeof null)?', 'null', 'undefined', 'object', 'number', 'C', 'In JavaScript, typeof null returns "object" due to a historical bug that was never fixed for backward compatibility.'),
('React', 'intermediate', 'Which hook is used for side effects in React?', 'useState', 'useEffect', 'useContext', 'useReducer', 'B', 'useEffect is used for side effects like data fetching, subscriptions, or manually changing the DOM.'),
('TypeScript', 'intermediate', 'What is the difference between interface and type in TypeScript?', 'No difference', 'Interface can be extended, type cannot', 'Type can use unions, interface cannot', 'Both B and C', 'D', 'Interfaces can be extended and merged, while types support unions and intersections but cannot be reopened.'),
('CSS', 'beginner', 'Which CSS property controls text size?', 'font-style', 'text-size', 'font-size', 'text-style', 'C', 'The font-size property is used to set the size of text in CSS.'),
('SQL', 'intermediate', 'What does ACID stand for in database transactions?', 'Atomicity, Consistency, Isolation, Durability', 'Active, Complete, Isolated, Durable', 'Atomic, Complete, Immediate, Direct', 'All, Complete, Isolated, Done', 'A', 'ACID ensures database transactions are Atomic, Consistent, Isolated, and Durable.');

-- Verification Query
-- Run this to confirm setup:
SELECT 
  'Tables Created' as status,
  COUNT(*) as mcq_questions_count
...
-- =============================================
-- DEPLOYMENT COMPLETE ✅
-- Next: Test by navigating to /recovery in app
-- =============================================

      ...
      <div className="min-h-screen p-6 lg:p-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Track your sessions and generate optimal timetables
          </p>
        </div>
          ...
          <TabsContent value="timetable">
            ...
            <div className="mb-6">
              ...
              <div className="flex gap-2">
                <Button
                  variant={timetableMode === 'teaching' ? 'chrono' : 'outline'}
                  size="sm"
                  onClick={() => setTimetableMode('teaching')}
                  className="gap-2"
                >
                ...
                <Button
                  variant={timetableMode === 'learning' ? 'chrono' : 'outline'}
                  size="sm"
                  onClick={() => setTimetableMode('learning')}
                  className="gap-2"
                >
